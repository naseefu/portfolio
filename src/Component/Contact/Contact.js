      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 w-[90%] mx-auto py-10' style={{alignItems:'stretch'}}>
        <div className='about text-left'>
          ...
          <div className='mt-8'>
            ...
            <input ref={(el)=>sectionsRef.current[3]=el}  type='text' placeholder='Name' className='about2 bg-[#0d0d0d] w-full md:w-[90%] mt-5 px-2 rounded-xl pl-5 py-5' style={{outline:"none"}} required/>
