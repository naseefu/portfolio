...
const Work7 = () => {
  ...
  return (
    <div onClick={()=>navigate("/work/lustre")} className='wcard works1 cursor-pointer bg-[rgba(255,255,255,0.05)] -mb-5 md:-mb-0 w-[90%] mx-auto px-3 py-5 md:p-10 rounded-[20px]'>
