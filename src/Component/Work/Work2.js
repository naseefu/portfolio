...
const Work2 = () => {
  ...
  return (
    <div onClick={()=>navigate("/work/zervings")} className='wcard works1 cursor-pointer bg-[rgba(255,255,255,0.1)] w-[90%] mx-auto px-3 py-5 md:p-10 rounded-[20px]'>
            ...
            <div>
              <div className='flex mx-[auto] justify-between py-10 pb-4 gap-4' style={{width:"95%",flexWrap:"wrap"}}>
                <p className='font-bold text-[20px] flex items-center gap-3 text-left'>Zervings - AI Powered Recipe Generator <span className='text-black bg-white p-1.5 rounded-[20px]'><GoArrowUpRight/></span></p>
                <p className='bg-[rgba(255,255,255,0.1)] flex items-center px-3 rounded-xl'>2024</p>
              </div>
              <div>
                <p className='text-left w-[95%] mx-[auto] text-gray-500'> Developed an AI-powered recipe generator which enables users to create 
